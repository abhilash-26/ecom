...
function Cart() {
  ...
  return (
    <div className='flex justify-between'>
      <div>
        {items.length == 0 && (
          <p className='text-4xl w-[80vw] h-[80vh]'>Your basket is empty!</p>
        )}
        {items.map((item) => (
          <div className='flex items-center m-1 border-b-2'>
            ...
            <div className='flex items-center m-10'>
              <button
                className='rounded-full border border-sky-500 w-6 m-1 text-xl flex justify-center'
              ...
              {item.count}
              <button
                className='rounded-full w-6 m-1 border border-sky-500 text-lg'
